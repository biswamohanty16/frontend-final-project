        ...
        <>
            ...
            <div style = {{display : "grid", margin : "5vw"}}>
                <div style = {{gridArea : "1/1/1/1"}}>
                    <input type = "text" id = "title" value = {newData.title} name = "title" style = {{fontSize : "30px"}} onChange = {handleChange} readOnly = {isReadOnly}/><i className="fa-solid fa-pen" style={{padding:"0px 10px"}} onClick = {toggleReadOnly}></i>
                    <br /><br/>
                    <input type = "text" id = "subtitle" name = "subtitle" value = {newData.subtitle} style = {{fontSize : "20px"}} readOnly = {isReadOnly} onChange = {handleChange}/><i className="fa-solid fa-pen" style={{padding:"0px 10px",fontSize : "10px"}} onClick = {toggleReadOnly}></i>
                    <br /><br /><br />
                    <input type = "text" id = "guide" value = "Guide" style= {{fontSize : "30px"}} readOnly = {isReadOnly} onChange = {handleChange}/><i className="fa-solid fa-pen" style={{padding:"0px 10px"}} onClick = {toggleReadOnly}></i>
                    <br />
                    <hr />
                    <br />
                    <input type = "text" id = "water" name = "water" value = {newData.careGuide.water} style = {{fontSize : "20px"}} onChange = {handleChange}/><i className="fa-solid fa-pen" style={{padding:"0px 10px"}} onClick = {toggleReadOnly}></i>
                    <br /><br />
                    <hr />
                    <br />
                    <input type = "text" id = "light" name = "light" value = {newData.careGuide.light} style = {{fontSize : "20px"}} onChange = {handleChange}/><i className="fa-solid fa-pen" style={{padding:"0px 10px"}} onClick = {toggleReadOnly}></i>
                    <br /><br />
                    <hr />
                    <br />
                    <input type = "text" id = "id" name="tips" value = {newData.careGuide.tips} style = {{fontSize : "20px"}} onChange = {handleChange}/><i className="fa-solid fa-pen" style={{padding:"0px 10px"}} onClick = {toggleReadOnly}></i>
                    <br /><br />
                    <hr />
                    <br /><br /><br />
                    <input type = "text" id = "description" name = "description" value = {newData.description} style = {{fontSize : "30px"}} readOnly = {isReadOnly} onChange = {handleChange}/><i className="fa-solid fa-pen" style={{padding:"0px 10px"}} onClick = {toggleReadOnly}></i>
                    <br/><br/>
                    <textarea rows = "3" placeholder = "Write your Description here" style = {{fontSize : "20px",width : "50vw"}} />
                </div>
                <div style = {{gridArea : "1/2/1/2"}}>
                    <img src={newData.pic} alt="pic" style = {{height:"70vh", width : "100%"}}/>
                    <br />
                    <input type = "file" id = "image" style = {{float : "right"}} onChange={handleImageChange}/>
                </div> 
            </div>
            <button style = {{marginLeft : "45vw"}} onClick={addProductToLocalStorage}>Save changes</button>
        </>
    )
}
